...
import org.overengineer.talelistener.ui.extensions.toFixed
import talelistener.composeapp.generated.resources.Res
import talelistener.composeapp.generated.resources.playback_speed_title
    ...
    ModalBottomSheet(
        ...
        content = {
            Column(
                ...
                Text(
                    text = "${selectedPlaybackSpeed.toFixed(2)}x",
