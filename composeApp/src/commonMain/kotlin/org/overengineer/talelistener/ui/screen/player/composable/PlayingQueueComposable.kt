...
fun PlayingQueueComposable(
    ...
    // todo: fling threshold is hardcoded for now, but this is problematic for desktop so we need another solution
    val expandFlingThreshold = remember { 500f }
    val collapseFlingThreshold = remember { 1000f }
    ...
    LaunchedEffect(currentTrackIndex) {
        // todo: this is android only, test without
        //awaitFrame()
        scrollPlayingQueue(
